<?php defined('BASEPATH') or exit('No direct script access allowed');
    ...
    {
        $this->db->select('ekspansi_request.comodity_name, ekspansi_request.user_id, ekspansi_request.request_id, ekspansi_request.destination, ekspansi_request.category, ekspansi_request.status, ekspansi_request.application, ekspansi_request.payment, ekspansi_request.create_date');
