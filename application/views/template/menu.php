        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            if (in_array($url, $listURL) && $this->uri->segment(3) != "detail_akun") { ?>
                ...
                <?php } ?>
                    ...
                    <?php } ?>
                    <?php if ($url == "commodities") { ?>
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a class="nav-link <?= $all; ?>" href="<?= site_url('commodities'); ?>">All</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?= $posted; ?>" href="<?= site_url('commodities/posted'); ?>">Posted</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?= $waiting_for_approval; ?>" href="<?= site_url('commodities/waiting_for_approval'); ?>">Waiting For Approval</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?= $draft; ?>" href="<?= site_url('commodities/draft'); ?>">Draft</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?= $unposted; ?>" href="<?= site_url('commodities/unposted'); ?>">Unposted</a>
                            </li>
                        </ul>
                    <?php } ?>
