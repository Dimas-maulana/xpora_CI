...
<table class="table-striped">
        ...
        <div class="container">
            <div class="main-body">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    ?>
                                        <form action="<?= site_url('detail_akun'); ?>/set_officer/<?= $id ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mt-2">
                            <form action="<?= site_url('detail_akun'); ?>/excel_verif/<?= $id ?>">
            ...
            <div class="col-lg-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        ?>
                            ...
                            <div class="row mb-3">
                                <form action="<?= site_url('detail_akun'); ?>/update_npwp/<?= $id ?>" method="post" enctype="multipart/form-data">
                                    <div class="col-sm-4 text-secondary">
                            ...
                            <div class="row mb-3">
                                <form action="<?= site_url('detail_akun'); ?>/update_siup/<?= $id ?>" method="post" enctype="multipart/form-data">
                                    <div class="col-sm-4 text-secondary">
                            ...
                            <div class="row mb-3">
                                <form action="<?= site_url('detail_akun'); ?>/update_peb/<?= $id ?>" method="post" enctype="multipart/form-data">
                                    <div class="col-sm-4 text-secondary">
                            ...
                            <div class="row mb-3">
                                <form action="<?= site_url('detail_akun'); ?>/update_akta/<?= $id ?>" method="post" enctype="multipart/form-data">
                                    <div class="col-sm-4 text-secondary">
                            ...
                            <div class="row mb-3">
                                <form action="<?= site_url('detail_akun'); ?>/update_domisili/<?= $id ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <form action="<?= site_url('detail_akun'); ?>/download_domisili/<?= $id ?>" method="post" enctype="multipart/form-data">
                                    <div cclass="col-sm-2 text-secondary">
                                        <button class="btn btn-success" type="submit" value=<?php echo $key["foto_akta"]; ?> name="download">Download</button>
                                    </div>
                                </form>
                ...
                <div class="card">
                    <?php
                    $number = 0;
                    foreach ($riwayat as $riwayat_ekspor) {
                    ?>
                        <div class="card-body">
                            ...
                            foreach ($img_riwayat as $img) {
                                if ($img['id_riwayat'] == $riwayat_ekspor['id_riwayat']) { ?>
                                    <form action="<?= site_url('detail_akun'); ?>/upd_riwayat_img/<?= $id ?>" method="post" enctype="multipart/form-data">
                                        <div class="row mb-3">
                                    ...
                                    <form action="<?= site_url('detail_akun'); ?>/download_riwayat/<?= $id ?>" method="post" enctype="multipart/form-data">
                                        <div cclass="col-sm-2 text-secondary">
                ...
                <form action="<?= site_url('detail_akun'); ?>/set_riwayat_img/<?= $id ?>" method="post" enctype="multipart/form-data">
                    <br>
                    <div class="row mb-3">
                        ...
                        <div class="sm-2">
                            <button class="btn btn-primary" type="submit" name="val" value="<?php echo $riwayat_ekspor['id_riwayat']; ?>">Upload Proof Pict</button>
                        </div>
                    </div>
                </form>
                </div>
            ...
            ?>
            <form action="<?= site_url('detail_akun'); ?>/set_riwayat/<?= $id ?>" method="post" enctype="multipart/form-data">
                <div class="card">
                        ...
                        <h6 class="font-weight-bold">Ekspor Baru
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12 text-secondary text-center">
                                    <button class="btn btn-secondary" type="submit" name="id_usaha">Tambah</button>
                                </div>
                            </div>
                    </div>
            </form>
                ...
                ?>
                    <form action="<?= site_url('detail_akun'); ?>/upd_kuantitas/<?= $id ?>" method="post" enctype="multipart/form-data">
                    ...
                    <form action="<?= site_url('detail_akun'); ?>/download_kuantitas/<?= $id ?>" method="post" enctype="multipart/form-data">
                        <div cclass="col-sm-2 text-secondary">
    ...
    <form action="<?= site_url('detail_akun'); ?>/set_kuantitas/<?= $id ?>" method="post" enctype="multipart/form-data">
        <div class="card">
            <div class="card-body">
